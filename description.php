...
">Job Description</h1>
    ...
    echo '<p>' . $job_title . '</p>';
    echo '<p>Desired Experience Range&nbsp&nbsp' . $experience . '</p>';
    echo '<p> Must have skils&nbsp&nbsp' . $skills . '</p>';
    echo '<p> We offered&nbsp&nbsp' . $salary . ' per month</p>';
    echo '<p>Location of Requirement&nbsp' . $location . '</p>';
    echo '<p>' . $summary . '</p>';
